...
import trackCover1 from "@/assets/track-cover-11.jpg";
import trackCover2 from "@/assets/track-cover-13.jpg";
import trackCover3 from "@/assets/track-cover-14.jpg";
import trackCover4 from "@/assets/track-cover-15.jpg";
...
const DarkCutPage = () => {
  return (
    <div data-theme="dark-cut" className="min-h-screen bg-background">
