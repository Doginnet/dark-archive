...
import trackCover1 from "@/assets/genre-haunted-garage.jpg";
import trackCover2 from "@/assets/track-cover-21.jpg";
import trackCover3 from "@/assets/track-cover-17.jpg";
import trackCover4 from "@/assets/track-cover-20.jpg";
...
const tracks: Track[] = [
  {
    ...
    audioUrl: "/audio/lowdown/Main.mp3",
...
// TODO: create a data-theme; Set pictures; Change names
      ...
      <header className="sticky top-0 z-50 glass-card border-b border-border/20 backdrop-blur-xl">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-foreground/70 mt-2 text-sm md:text-base tracking-wide">
            Downtempo beats / Recollected scraps
          </p>
        </div>
      </header>
